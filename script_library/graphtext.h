...
void graph_text_xy_schar( uchar N,  schar X,  schar Y,  schar Z, short X0, short Y0) { __graph_text_xy_common1(core_io.BufS1)  __graph_text_xy_common2(core_io.BufS1)  __graph_text_xy_common3(core_io.BufS1)  __graph_text_xy_common4(0)  __graph_text_xy_common5 __graph_text_xy_common6 __graph_text_xy_common7 }
...
void graph_text_xy_sshort(uchar N, sshort X, sshort Y, sshort Z, short X0, short Y0) { __graph_text_xy_common1(core_io.BufS2)  __graph_text_xy_common2(core_io.BufS2)  __graph_text_xy_common3(core_io.BufS2)  __graph_text_xy_common4(4)  __graph_text_xy_common5 __graph_text_xy_common6 __graph_text_xy_common7 }
...
void graph_text_xy_sint(  uchar N,   sint X,   sint Y,   sint Z, short X0, short Y0) { __graph_text_xy_common1(core_io.BufS2x) __graph_text_xy_common2(core_io.BufS2x) __graph_text_xy_common3(core_io.BufS2x) __graph_text_xy_common4(6)  __graph_text_xy_common5 __graph_text_xy_common6 __graph_text_xy_common7 }
...
void graph_text_xy_slong( uchar N,  slong X,  slong Y,  slong Z, short X0, short Y0) { __graph_text_xy_common1(core_io.BufS4)  __graph_text_xy_common2(core_io.BufS4)  __graph_text_xy_common3(core_io.BufS4)  __graph_text_xy_common4(8)  __graph_text_xy_common5 __graph_text_xy_common6 __graph_text_xy_common7 }
...
void graph_text_schar_v(uchar N, schar V)  { schar V_ = V;  _uchar[mem_swap + 1] =  0; core_io.BufS1 = V_; _uchar[mem_swap] = IOGraphTextCmd + 8 + N; }
...
void graph_text_schar_t(uchar N, schar V)  { schar V_ = V;  _uchar[mem_swap + 1] =  2; core_io.BufS1 = V_; _uchar[mem_swap] = IOGraphTextCmd + 8 + N; }
...
void graph_text_sshort( uchar N, sshort V) { sshort V_ = V; _uchar[mem_swap + 1] =  4; core_io.BufS2 = V_; _uchar[mem_swap] = IOGraphTextCmd + 8 + N; }
...
void graph_text_sint(   uchar N, sint V)   { sint V_ = V;   _uchar[mem_swap + 1] =  6; core_io.BufS2 = V_; _uchar[mem_swap] = IOGraphTextCmd + 8 + N; }
void graph_text_uint(   uchar N, uint V)   { uint V_ = V;   _uchar[mem_swap + 1] =  7; core_io.BufU2 = V_; _uchar[mem_swap] = IOGraphTextCmd + 8 + N; }
void graph_text_slong(  uchar N, slong V)  { slong V_ = V;  _uchar[mem_swap + 1] =  8; core_io.BufS4 = V_; _uchar[mem_swap] = IOGraphTextCmd + 8 + N; }
