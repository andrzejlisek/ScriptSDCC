...
// R, G, B - Point color
void graph_plot_schar( uchar N,  schar X,  schar Y,  schar Z, uchar R, uchar G, uchar B) { __graph_plot_common1(core_io.BufS1)  __graph_plot_common2(core_io.BufS1)  __graph_plot_common3(core_io.BufS1)  __graph_plot_common4(0)  __graph_plot_common5 __graph_plot_common6 }
...
void graph_plot_sshort(uchar N, sshort X, sshort Y, sshort Z, uchar R, uchar G, uchar B) { __graph_plot_common1(core_io.BufS2)  __graph_plot_common2(core_io.BufS2)  __graph_plot_common3(core_io.BufS2)  __graph_plot_common4(4)  __graph_plot_common5 __graph_plot_common6 }
...
void graph_plot_sint(  uchar N,   sint X,   sint Y,   sint Z, uchar R, uchar G, uchar B) { __graph_plot_common1(core_io.BufS2x) __graph_plot_common2(core_io.BufS2x) __graph_plot_common3(core_io.BufS2x) __graph_plot_common4(6)  __graph_plot_common5 __graph_plot_common6 }
...
void graph_plot_slong( uchar N,  slong X,  slong Y,  slong Z, uchar R, uchar G, uchar B) { __graph_plot_common1(core_io.BufS4)  __graph_plot_common2(core_io.BufS4)  __graph_plot_common3(core_io.BufS4)  __graph_plot_common4(8)  __graph_plot_common5 __graph_plot_common6 }
